          ...
          <Card className="card-shadow border-0">
            ...
            <CardContent className="space-y-6">
              <div className="border-l-4 border-primary pl-6">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Indian Institute of Management, Tiruchirappalli</p>
                  </div>
                </div>
              ...
              <div className="border-l-4 border-primary pl-6">
                <div className="flex items-center gap-3 mb-2">
                  <img 
                    src="/mahanthy doc-uploads/3dfb4478-02a2-41f1-9370-12c07ebd0696.png" 
                    alt="IIT Patna logo"
                    className="w-12 h-12 object-contain"
                  />
                  <div>
                    <h3 className="text-xl font-semibold text-foreground">Bachelor of Technology</h3>
                    <p className=" font-medium">Indian Institute of Technology, Patna</p>
                  </div>
                </div>
