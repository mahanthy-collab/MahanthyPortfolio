...
const Internships = () => {
  const internships = [
    {
      ...
      logo: "/mahanthy doc-uploads/51abc131-8dde-4086-a62b-e46c96a4b41f.png",
      role: "Data Analyst Intern",
      type: "Summer Internship 2022"
    },
    {
      name: "Success Numbers",
      logo: "/mahanthy doc-uploads/5d938e11-adeb-41fd-a9e8-cb3acb5c863f.png", 
  ...
  const associatedOrganizations = [
    ...
    },
    {
      ...
      logo: "/mahanthy doc-uploads/4fefd786-58dc-41ab-9e87-da5f7a812440.png"
    },
    {
      name: "DRDO",
      logo: "/mahanthy doc-uploads/48aef1c7-4960-49c4-ba04-18ffd9526819.png"
    },
    {
      name: "SWACHH AI",
      logo: "/mahanthy doc-uploads/8e2e35da-60c5-4ca0-9762-0e14a2b26e60.png"
    },
    {
      name: "ISRO",
      logo: "/mahanthy doc-uploads/a50b3b73-745e-4611-918e-815831df4730.png"
    }
  ];
          ...
          {internships.map((internship, index) => (
            <Card key={index} className="card-shadow border-0 hover:shadow-lg transition-all duration-300 group">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm group-hover:text-white font-medium mb-1">{internship.role}</p>
            ...
            {associatedOrganizations.map((org, index) => (
              <div key={index} className="opacity-60 hover:opacity-100 transition-opacity duration-300">
                <img 
                  src={org.logo}
                  alt={`${org.name} logo`}
                  className="h-24 object-contain bg-gradient-to-r from-[#fff] to-[hsl(0,90%,65%)] hover:grayscale-0 transition-all duration-300"
                />
              </div>
            ))}
          </div>
