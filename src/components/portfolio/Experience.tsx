                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div className="flex items-center gap-4">
                    <div className="bg-background/50 hover:bg-background transition-colors duration-300 rounded-lg p-2 shadow-sm group">
                      <img 
                        src="/mahanthy doc-uploads/4fefd786-58dc-41ab-9e87-da5f7a812440.png" 
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="bg-background/50 hover:bg-background transition-colors duration-300 rounded-lg p-1 shadow-sm group">
                      <img 
                        src={internship.company === "Success Numbers" ? "/mahanthy doc-uploads/5d938e11-adeb-41fd-a9e8-cb3acb5c863f.png" : "/mahanthy doc-uploads/51abc131-8dde-4086-a62b-e46c96a4b41f.png"} 
